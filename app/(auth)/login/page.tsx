        ...
        <div className="w-full rounded-lg shadow ">
          ...
          <div className="md:w-[445px]  my-8 w-auto">
            ...
            <button
              ...
              className="w-full mt-3 text-white bg-primary hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-prborder-primary dark:hover:bg-primary-700 dark:focus:ring-primary-800"
            >
              SignIN with Google
            </button>
          </div>
